...
/*
    ...
    */
    ...
    material1.specularColor.set(0.2,0.2,0.2);
    let material4 = new BABYLON.StandardMaterial("mat", scene);
    material4.diffuseColor.set(1, 0, 1);
    ...
    let orb_small = MYLIB.createDrop(0.6,0.6,0.4,-0.5,position1,0,0,0,Math.PI/2,1,1,1,material4);
    let orb_big = MYLIB.createDrop(0.7,1,0.8,-0.5,position1,0,0,0,-Math.PI/2,1,1,1,material4);
